...
This project has stopped the developing on 2019 because there are many bug i haven't the time to manage, 
especiaaly for Alfresco 5 and 6 so anyone is willing to take some action on it is more than welcome
