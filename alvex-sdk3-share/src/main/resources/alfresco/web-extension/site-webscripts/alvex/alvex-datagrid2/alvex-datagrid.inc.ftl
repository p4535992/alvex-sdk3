...
<!-- Data Grid -->
<@link rel="stylesheet" type="text/css" href="${url.context}/res/alvex/alvex-datagrid2/css/components/alvex/datalists/datagrid.css" />
<@script type="text/javascript" src="${url.context}/res/modules/data-lists/datalist-actions.js" />
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-utils/js/components/alvex.js" />
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid2/js/components/alvex/datalists/datagrid-renderers.js" />
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid2/js/components/alvex/datalists/datagrid-search.js" />
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid2/js/components/alvex/datalists/datagrid-search-renderers.js" />
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid2/js/components/alvex/datalists/datagrid.js" />
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid2/js/components/alvex/datalists/datagrid-actions.js" />
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-utils/js/components/alvex/simple-dialog.js" />
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-utils/js/components/alvex/interval-calendar.js" />
