...
<!-- Document Versions -->
<@script type="text/javascript" src="${page.url.context}/res/alvex/alvex-datagrid2/js/components/alvex/datalists/datalist-versions.js"></@script>
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/alvex/alvex-datagrid2/css/components/alvex/datalists/datalist-versions.css" />
