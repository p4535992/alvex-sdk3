...
<@script type="text/javascript" src="${page.url.context}/res/alvex/alvex-utils/js/components/alvex-create-site.js" />
<@script type="text/javascript" src="${page.url.context}/res/alvex/alvex-utils/js/components/alvex-manage-sites.js" />
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/alvex/alvex-utils/css/components/alvex-manage-sites.css" />
