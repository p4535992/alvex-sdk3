<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link href="${url.context}/res/alvex/alvex-project-management/css/components/alvex/alvex-task-toolbar.css" group="workflow"/>
   <@link href="${page.url.context}/res/components/people-finder/people-finder.css" group="workflow"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script src="${url.context}/res/alvex/alvex-project-management/js/components/alvex/alvex-task-toolbar.js" group="workflow"/>
