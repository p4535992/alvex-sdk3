...
<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link href="${url.context}/res/alvex/alvex-project-management/css/components/alvex/alvex-task-projects.css" group="workflow"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script src="${url.context}/res/alvex/alvex-project-management/js/components/alvex/alvex-task-projects.js" group="workflow"/>
</@>
