...
<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link href="${url.context}/res/alvex/alvex-project-management/css/components/alvex/alvex-task-relations.css" group="workflow"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script src="${url.context}/res/alvex/alvex-project-management/js/components/alvex/alvex-task-relations.js" group="workflow"/>
