...
<@link rel="stylesheet" type="text/css" href="${url.context}/res/alvex/alvex-datagrid/css/components/alvex/datalists/datagrid.css" group="datalistsAlvexDataGrid"/>
...
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid/js/components/alvex/datalists/datagrid-renderers.js" group="datalistsAlvexDataGrid"/>
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid/js/components/alvex/datalists/datagrid-search.js" group="datalistsAlvexDataGrid"/>
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid/js/components/alvex/datalists/datagrid-search-renderers.js" group="datalistsAlvexDataGrid"/>
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid/js/components/alvex/datalists/datagrid.js" group="datalistsAlvexDataGrid"/>
<@script type="text/javascript" src="${url.context}/res/alvex/alvex-datagrid/js/components/alvex/datalists/datagrid-actions.js" group="datalistsAlvexDataGrid"/>
