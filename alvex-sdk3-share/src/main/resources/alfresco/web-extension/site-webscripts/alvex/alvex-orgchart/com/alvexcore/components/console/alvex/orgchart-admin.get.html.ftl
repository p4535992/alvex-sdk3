...
<script type="text/javascript">//<![CDATA[
	var currentAlvexOrgchartViewer = new Alvex.OrgchartViewer("${htmlId}").setOptions({
		mode: "admin",
	...
	//MOD 4535992
	var currentAlvexOrgchartGroupViewer = new Alvex.OrgchartGroupViewer( "${htmlId}" ).setOptions({
        mandatory: false,
