...
<script type="text/javascript">//<![CDATA[
   new Alvex.OrgchartPeopleFinder("${el}").setOptions(
   {
      ...
      viewMode: ${args.viewMode!"Alvex.OrgchartPeopleFinder.VIEW_MODE_DEFAULT"}
   }).setMessages(
      ${messages}
   );
//]]></script>
...
<div id="${el}-body" class="people-finder list">
   ...
   <div class="finder-wrapper">
      ...
      <div id="${el}-role-column-template" style="display:none">
