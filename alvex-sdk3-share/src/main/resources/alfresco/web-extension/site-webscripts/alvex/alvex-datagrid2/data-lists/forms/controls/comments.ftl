...
<@link rel="stylesheet" type="text/css" href="${url.context}/res/alvex/alvex-datagrid2/js/components/alvex/datalists/form/comments.css" />
<@script type="text/javascript" src="${page.url.context}/res/alvex/alvex-datagrid2/js/components/alvex/datalists/form/comments.js"></@script>
