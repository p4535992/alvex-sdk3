...
(function() {
	...
	Alvex.DataGrid = function(htmlId) {
		Alvex.DataGrid.superclass.constructor.call(this, htmlId);
		//Alvex.DataGrid..superclass.constructor.call(this, "null");
	...
	//MOD 4535992
	YAHOO.extend(Alvex.DataGrid, Alfresco.component.DataGrid);
	//END MOD4535992
	/**
	 * Augment prototype with Common Actions module
	 */
	// TODO: do not use this augment, see comments in datagrid-actions.js for details
	//YAHOO.lang.augmentProto(Alvex.DataGrid, Alfresco.service.DataListActions); //4535992
