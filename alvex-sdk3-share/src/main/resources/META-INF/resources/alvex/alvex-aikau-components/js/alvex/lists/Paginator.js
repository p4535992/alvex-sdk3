/*
  Fork of alfresco/lists/Paginator not to render page selector and to render text about the list size.
*/
define(["dojo/_base/declare",
   ...
   return declare([AlfMenuBar, _AlfDocumentListTopicMixin, _PreferenceServiceTopicMixin], {
       ...
       */
      postMixInProperties: function alvex_lists_Paginator__postMixInProperties() {
       ...
       */
      onDocumentsPerPageChange: function alvex_lists_Paginator__onDocumentsPerPageChange(payload) {
       ...
       */
      onPageBack: function alvex_lists_Paginator__onPageBack(payload) {
         // jshint unused:false
       ...
       * @fires pageSelectionTopic
       */
      onPageForward: function alvex_lists_Paginator__onPageForward(payload) {
         // jshint unused:false
         var label, pageStart, pageEnd;
       ...
       */
      onDocumentsLoaded: function alvex_lists_Paginator__onDocumentsLoaded(payload) {
       ...
       */
      hideControls: function alvex_lists_Paginator__hideControls(/*jshint unused:false*/ payload) {
         when(this._controlsLoaded, lang.hitch(this, function() {
            ...
            domClass.add(this.pageTotal.domNode, "hidden");
       ...
       */
      processLoadedDocuments: function alvex_lists_Paginator__processLoadedDocuments(payload) {
             ...
             (startIndex || startIndex === 0))
         {
            ...
            else
            {
               ...
               domClass.remove(this.pageTotal.domNode, "hidden");
               if (this.resultsPerPageGroup)
               {
               ...
               if (this.pageTotal)
               {
                 ...
                 if (this.totalRecords == 1000000) {
                   this.pageTotal.set("label", "list.paginator.search.warning");
                 } else {
                   this.pageTotal.set("label", this.message("list.paginator.total") + this.totalRecords.toString());
                 }
                  domClass.remove(this.pageTotal.domNode, "dijitDisabled dijitMenuItemDisabled");
               }
       ...
       */
      createPageSizeMenuItem: function alvex_lists_Paginator__createPageSizeMenuItem(pageSizeMenuItems, pageSize) {
       ...
       */
      isValidPageSize: function alvex_lists_Paginator__isValidPageSize(requestedPageSize) {
       ...
       * @instance
       */
      postCreate: function alvex_lists_Paginator__postCreate() {
       ...
       * @instance
       */
      allWidgetsProcessed: function alvex_lists_Paginator__allWidgetsProcessed() {
         this.inherited(arguments);
         ...
         this.pageTotal = registry.byId(this.id + "_TOTAL_COUNT");
         ...
         domClass.add(this.pageTotal.domNode, paginatorClass + "__page-total");
         if (this.compactMode === false) {
       ...
       */
      checkAndUpdatePageSelectionMenu : function alvex_lists_Paginator__checkAndUpdatePageSelectionMenu() {
