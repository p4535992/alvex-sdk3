...
(function()
{
    ...
    * @return {Alvex.ConsoleUsers2} The new ConsoleUsers instance
    * @constructor
    */
   Alvex.ConsoleUsers2 = function(htmlId)
   {
      this.name = "Alvex.ConsoleUsers2";
      Alvex.ConsoleUsers2.superclass.constructor.call(this, htmlId);
         ...
         */
         ...
         _setupDataTable: function _setupDataTable()
         {
            ...
            parent.widgets.pagingDataTable = new Alfresco.util.DataTable(
            {
               ...
               dataSource:
               {
                  url: Alfresco.constants.PROXY_URI + (parent.options.showAuthorizationStatus ? "api/people-enterprise" : "alvex/alvex-middle-name/api/people"),
         ...
         _setDefaultDataTableErrors: function _setDefaultDataTableErrors(dataTable)
         {
            ...
            dataTable.set("MSG_EMPTY", parent._msg("message.empty", "Alvex.ConsoleUsers2"));
            dataTable.set("MSG_ERROR", parent._msg("message.error", "Alvex.ConsoleUsers2"));
         },
      ...
      YAHOO.extend(ViewPanelHandler, Alfresco.ConsolePanelHandler,
      {
         ...
         onUpdate: function onUpdate()
         {
            ...
            {
               url: Alfresco.constants.PROXY_URI + "alvex/alvex-middle-name/api/people/" + encodeURIComponent(parent.currentUserId) + "?groups=true",
   ...
   YAHOO.extend(Alvex.ConsoleUsers2, Alfresco.ConsoleTool,
   {
      /**
      ...
      onReady: function ConsoleUsers_onReady()
      {
         ...
         Alvex.ConsoleUsers2.superclass.onReady.call(this);
      },
      ...
      onDeleteUserOK: function ConsoleUsers_onDeleteUserOK(e)
      {
         Alfresco.util.Ajax.request(
         {
            ...
            url: Alfresco.constants.PROXY_URI + "alvex/alvex-middle-name/api/people/" + encodeURIComponent(this.currentUserId),
            successCallback:
            {
      ...
      _createUser: function ConsoleUsers__createUser(handler)
      {
         ...
         Alfresco.util.Ajax.request(
         {
            url: Alfresco.constants.PROXY_URI + "alvex/alvex-middle-name/api/people",
            method: Alfresco.util.Ajax.POST,
            dataObj: personObj,
            requestContentType: Alfresco.util.Ajax.JSON,
            successCallback:
