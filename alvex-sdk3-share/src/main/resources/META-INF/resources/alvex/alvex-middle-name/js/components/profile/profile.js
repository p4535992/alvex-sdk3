...
(function()
{
    ...
    * @return {Alvex.UserProfile2} The new UserProfile instance
    * @constructor
    */
   Alvex.UserProfile2 = function(htmlId)
   {
      Alvex.UserProfile2.superclass.constructor.call(this, "Alvex.UserProfile2", htmlId, ["button"]);
      return this;
   };
   
   YAHOO.extend(Alvex.UserProfile2, Alfresco.component.Base,
   {
      /**
