...
(function()
{
		...
		YAHOO.extend(PanelHandler, Alfresco.ConsolePanelHandler,
		{
			onLoad: function onLoad()
			{
				...
				parent.widgets.dataSource = new YAHOO.util.DataSource(Alfresco.constants.PROXY_URI 
					+ "api/alvex/workflow-permissions/admin/allowed-workflows?",
				{
				...
				var renderActions = function renderActions(elCell, oRecord, oColumn, oData)
				{
					...
					removeLink.innerHTML = '<div style="text-align:right;">' 
						...
						//+ 'img/components/workflow-permissions-admin/document-delete-16.png' //MOD 4535992
						+ 'alvex/alvex-workflow-permissions/img/components/workflow-permissions-admin/document-delete-16.png'
						+ '"/> ' 
	...
	YAHOO.extend(Alvex.WorkflowPermissionsAdmin, Alfresco.ConsoleTool,
	{
		options:
		{
			workflowDefinitions: [],
		...
		{
			Alvex.WorkflowPermissionsAdmin.superclass.onReady.call(this);
		},
		...
		onRemoveWorkflowClick: function WSA_onRemoveWorkflowClick(e, args)
		{
			...
			var url = Alfresco.constants.PROXY_URI 
				+ "api/alvex/workflow-permissions/admin/allowed-workflows?group=" 
		...
		onWorkflowAdd: function WSA_onWorkflowAdd(sType, aArgs)
		{
			...
			Alfresco.util.Ajax.request({
				url: Alfresco.constants.PROXY_URI + "api/alvex/workflow-permissions/admin/allowed-workflows",
