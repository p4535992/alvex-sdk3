<import resource="classpath:alfresco/extension/templates/webscripts/alvex/alvex-utils/alvex-config/alvex-config.lib.js">
...
(function(){
	try{
		...
		if( ! uiConfig )
			uiConfig = Alvex.configs.createConfig('orgchart', 'orgchart-view.default');
