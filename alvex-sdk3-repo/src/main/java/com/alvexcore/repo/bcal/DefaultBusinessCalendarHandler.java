...
public class DefaultBusinessCalendarHandler extends AbstractBusinessCalendarHandler {
	...
	private static final transient org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(DefaultBusinessCalendarHandler.class);
    ...
    public Map<String, Object> buildEmailModel(Task task, NodeRef personRef) {
        ...
        //MOD 4535992 MANAGE CASE WITH workflowPackage==null
        if(workflowPackage==null) {
        	logger.warn("Without this check workflowPackage.getChildren() fails with NPE if package is empty");
        }
        if (workflowPackage!=null && workflowPackage.getHasChildren()) {
