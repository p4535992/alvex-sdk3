...
public class CustomBusinessCalendarHandler extends AbstractBusinessCalendarHandler {
	...
	private static final transient org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(CustomBusinessCalendarHandler.class);
    ...
    public Map<String, Object> buildEmailModel(Task task, NodeRef personRef) {
    	try {
    		logger.warn("Builde Email Model is not defined on this class");
    		return null;
    	}catch(Throwable ex) {
